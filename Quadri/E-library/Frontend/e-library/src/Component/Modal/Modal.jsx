  ...
  return (
    <div className="fixed top-0 left-0 w-screen overflow-hidden h-screen  bg-white z-40">
        <div  className=" w-8/12 h-[500px] rounded-md shadow-md border relative mx-auto bg-white mt-5 mb-8">
            <div key={book ? book._id : ""} className='w-[350px] h-[450px] mx-auto my-6 border shadow-2xl rounded-md'>
              <div className='w-[100px] h-[100px] mx-auto rounded-md my-4'>
                <div className='w-full h-full'>
                  <img src={book ? book.coverImage : ""} alt="" className='w-full h-full rounded-md' />
                </div>
              </div>
              ...
              <div className='flex justify-end'>
                <button className='mr-4 p-2 rounded-xl text-white font-inter font-semibold bg-green-600 hover:bg-green-300 hover:text-black'>Borrow Book</button>
              </div>
            </div>
