...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='relative w-full hidden lg:block'>
      ...
      <div className='w-[70px] h-[70px] mx-auto rounded-full shadow-lg'>
        <img src={Avatar} alt="" className='w-full h-full rounded-full bg-cover'/>
      </div>
      <p className='text-center font-inter font-semibold text-xl pb-8'> Witcher</p>
      <div className='w-5/6 mx-auto '>
        <div className='w-full flex flex-col'>
          ...
          <div onClick={logoutHandler} className='flex justify-start items-center cursor-pointer p-1 gap-2 mb-6 text-green-600 hover:bg-green-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out'>
  ...
  //   <div
  //     id="sidebar"
  //     className="bg-white fixed h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-y-hidden transition-transform duration-300 ease-in-out"
  //     // x-show="sidenav"
